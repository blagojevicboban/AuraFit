          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <h2 className="text-3xl font-display font-bold mb-2">
                {loginRole === 'admin' ? 'Admin Access' : loginRole === 'coach' ? 'Coach Portal' : 'Client Login'}
              </h2>
              <p className="text-zinc-400 mb-10 font-light">
                Dobrodošli nazad u Aura Fit zajednicu.
              </p>
              ...
              <form onSubmit={handlePasswordLogin} className="space-y-6">
                ...
                <div className="relative flex items-center gap-4 py-2">
                  ...
                  <span className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em]">ili</span>
                  <div className="flex-grow h-px bg-white/10"></div>
                </div>
